...
const HomePage: React.FC = () => {
  return (
    <DefaultLayout className="HomePage">
      ...
      <MainImage/>
      <p>Lorem Lorem 333 ipsum dolor sit amet consectetur adipisicing elit. Excepturi officia magnam sunt? Sunt harum obcaecati, fuga consequatur, suscipit recusandae totam expedita modi facilis, officiis facere nihil dignissimos tenetur asperiores aut?</p>
      <AsideImageOuter>
        <img
